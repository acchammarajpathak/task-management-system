...
?>
  ...
  <!-- Hero Section  -->
  <section class="navbar-nav mx-5  mb-2 mb-lg-0">
    <div>
     
      <div style="background-image: url('img/Banner.jpg');">   

      
      <span><h1>Hello, </h1></span>
        <h1>This is 201IT <span></span></h1>
        <h1>A Complete IT Solution <span></span></h1>
        <a href="#projects" type="button" class="cta">Recent Project</a>
        </a>
      </div>
